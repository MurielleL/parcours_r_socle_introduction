...
[Le site CRAN = Comprehensive R Archive Network](https://cran.r-project.org) est le site de référence pour R. Il contient non seulement les installeurs du logiciel mais également de nombreuses ressources : documentations, FAQ, tutoriels... 
